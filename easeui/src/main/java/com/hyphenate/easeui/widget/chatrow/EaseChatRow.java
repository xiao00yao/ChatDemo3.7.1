    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView); //设置图像
            } else {
                EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);//设置图像
